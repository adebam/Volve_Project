...
production_file_path = Path("../0_Volve_dataset/5_Production_data/Volve_production_data.xlsx")
production_df = Load_clean_production_data(production_file_path)
...
polygon_file_path = Path("../0_Volve_dataset/2_Geophysical_Interpretations/Fault_polygons/2014_Volve_Hugin_Base.dat")
print(polygon_file_path.exists())
print(polygon_file_path.resolve())
